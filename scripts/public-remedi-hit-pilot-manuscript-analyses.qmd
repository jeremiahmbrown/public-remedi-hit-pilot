...
data <- rawdata %>% 
  filter(mTurkCode != 'NA' & Status == "IP Address" & group != 'NA' & IPAddress != 'NA' &
           StartDate > '2022-02-10 11:10:00' & mTurk_ID != 'test') %>% 
  mutate(mTurkCode = as.factor(mTurkCode), id = row_number(),
         id = as.factor(id), group = as.factor(group)) %>% 
  select(id, Progress, IPAddress, mTurk_ID, mTurkCode, diagnoses1_score, diagnoses2_score, BMI, 
         age = Q3988, edu = Q3982, gender = Q3987, income = Q3984, cont_ladder, hba1c = Q206,
         group:ncc_ac) %>% 
  mutate(age = as.numeric(age)) %>%
  rename(eft_cue1month = eft_cue1month...822,
         eft_cue3month = eft_cue3month...823,
         eft_cue6month = eft_cue6month...824,
         eft_cue1year = eft_cue1year...825,
         eft_cue3year = eft_cue3year...826,
         eft_cue5year = eft_cue5year...827,
         eft_cue10year = eft_cue10year...828,
         hit_cue1 = hit_cue1...829,
         hit_cue2 = hit_cue2...830,
         hit_cue3 = hit_cue3...831,
         hit_cue4 = hit_cue4...832,
         hit_cue5 = hit_cue5...833,
         hit_cue6 = hit_cue6...834,
         hit_cue7 = hit_cue7...835)
...
#recode hba1c values to decrease number of categories
data$hba1c <- data |> 
...
eft_all <- rawdata |> 
  filter(Status == "IP Address" & StartDate > '2022-02-10 11:10:00' & mTurk_ID != 'test') |> 
...
n_bmi_diag_excluded <- rawdata |> 
  ...
  select(Access, BMI, diagnoses1_10:diagnoses1_12, diagnoses2_10:diagnoses2_12,
...
# ggsave("plots/flow_diagram.png", dpi = 1000, device = png, width = 10, height = 10)
# 
